...
class Service
{
//    public function createFromPrevious(RoundNumber $roundNumber): Dep {
//        $previousConfig = $roundNumber->getPrevious()->getConfig();
//        $config = new Dep($roundNumber);
...
//        $config->setPointsCalculation(Dep::POINTS_CALC_GAMEPOINTS);
...
//    }
//
//    protected function createScoreConfig(Dep $config ): ConfigScore {
...
//    }
//
//    protected function createScoreConfigFromRoundHelper( Dep $config, string $name, int $direction, int $maximum, ConfigScore $parent = null ): ConfigScore {
...
//    }
//
//    protected function copyScoreConfigFromPrevious(Dep $config, ConfigScore $scoreConfig) {
