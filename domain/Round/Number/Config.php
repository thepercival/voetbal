...
use Voetbal\Round\Number\Config\Options as RoundNumberConfigOptions;
use Voetbal\Round\Number\Config\OptionsTrait;
...
class Config
{
    ...
    public function getOptions(): RoundNumberConfigOptions
    {
        $configOptions = new RoundNumberConfigOptions();
    ...
    public function setOptions(RoundNumberConfigOptions $configOptions)
    {
